import ProjectCard from '@/components/modules/time-tracking/ProjectCard/ProjectCard';
import { createClient } from '@/utils/supabase/server';
import { PostgrestResponse } from '@supabase/supabase-js';
import React from 'react';
import { TimeTrackingProject } from '../api/supabaseTypes';
import AddProjectButton from '@/components/modules/time-tracking/AddProjectButton/AddProjectButton';
