...
export class SportEventItemEdit extends Component<SportEventItemEditProps, SportEventItemEditState> {
  ...
  private tabs = ["SportEvent", "EventDetails", "Content"]
        ...
        { LanguageContext => (
          <div style={{ height: "100%", display: "flex", flexDirection: "column"}}>
            ...
            }
            {
              ...
              <ConfirmPopUp
                title={LanguageContext.t("sport:Error")}
                warning={LanguageContext.t("sport:ErrorWarning")}
                onConfirm={() => {
              ...
              <div className={sportEventItemStyles.left}>
                <div className={sportEventItemStyles.sportHeading}>
                  <h1 className={sportEventItemStyles.sport}>
                    { LanguageContext.t("sport:" + this.state.sportEvent.sport?.name) }
                  </h1>
                  <p>
                    { LanguageContext.t("sport:" + this.state.sportEvent.sportEventType?.name) }
                  </p>
                </div>
              ...
              <div className={styles.innerNav}>
                {
                  this.tabs.map((tab, index) => {
                    return (
                      ...
                      >
                        {LanguageContext.t("sport:Tab" + tab)}
                      </div>
                    )
                  })
                }
              ...
              <div className={styles.innerContent}>
                ...
                }
                {
                  ...
                  <div className={sportEventItemStyles.content} style={{borderTop: "none"}}>
                    ...
                    >
                      {LanguageContext.t("sport:AddSportMatch")}
                    </Button>
                  </div>
                }
                {
